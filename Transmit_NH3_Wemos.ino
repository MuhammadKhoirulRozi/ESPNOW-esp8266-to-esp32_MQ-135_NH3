...
uint8_t broadcastAddress[] = {0xAC, 0x27, 0x6E, 0x5E, 0x93, 0x08}; //AC:27:6E:5E:93:08 AC:27:6E:5E:93:08
...
typedef struct struct_message {
  ...
  float rs;
  float vout;
  float temp1; // Variabel suhu
  float hum1;  // Variabel kelembapan
} struct_message;
...
void loop() {
  ...
  float ratio = Rs / R0;
  float ppm1 = a * pow(ratio, b);

  // === 3. Cetak ke Serial Monitor untuk debugging ===
  Serial.print("Suhu: "); Serial.print(temp1); Serial.print(" C\t");
  Serial.print("Kelembapan: "); Serial.print(hum1); Serial.print(" %\t");
  Serial.print("PPM NH3: "); Serial.print(ppm1, 2);
