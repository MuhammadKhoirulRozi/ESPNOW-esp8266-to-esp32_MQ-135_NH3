...
//   float rs;
//   float vout;
//   float temp3; // Variabel suhu
//   float hum3;  // Variabel kelembapan
// } struct_message;
...
//   float ratio = Rs / R0;
//   float ppm3 = a * pow(ratio, b);

//   // === 3. Cetak ke Serial Monitor untuk debugging ===
//   Serial.print("Suhu: "); Serial.print(temp3); Serial.print(" C\t");
//   Serial.print("Kelembapan: "); Serial.print(hum3); Serial.print(" %\t");
//   Serial.print("PPM NH3: "); Serial.println(ppm3, 2);
