...
//   float rs;
//   float vout;
//   float temp4; // Variabel suhu
//   float hum4;  // Variabel kelembapan
// } struct_message;
...
// void loop() {
//   // === 1. Baca Sensor DHT22 ===
//   float hum4 = dht.readHumidity();
//   float temp4 = dht.readTemperature();
...
//   float ratio = Rs / R0;
//   float ppm4 = a * pow(ratio, b);

//   // === 3. Cetak ke Serial Monitor untuk debugging ===
//   Serial.print("Suhu: "); Serial.print(temp4); Serial.print(" C\t");
//   Serial.print("Kelembapan: "); Serial.print(hum4); Serial.print(" %\t");
//   Serial.print("PPM NH3: "); Serial.println(ppm4, 2);
